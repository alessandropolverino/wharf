...
```bash
uvx --from git+https://github.com/alessandropolverino/wharf.git@v0.3.0 wharf --help

# or, into a virtualenv:
pip install "wharf @ git+https://github.com/alessandropolverino/wharf.git@v0.3.0"

# or, as a standalone global tool (recommended for actual use):
uv tool install --from git+https://github.com/alessandropolverino/wharf.git@v0.3.0 wharf
```
